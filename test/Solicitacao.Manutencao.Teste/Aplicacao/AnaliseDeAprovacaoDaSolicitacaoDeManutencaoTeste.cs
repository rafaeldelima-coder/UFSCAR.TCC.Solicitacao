...
namespace Solicitacao.Manutencao.Teste.Aplicacao
{
    public class AnaliseDeAprovacaoDaSolicitacaoDeManutencaoTeste
    {
        ...
        {
            _dto = new AnaliseDeAprovacaoDto { IdDaSolicitacao = "GRMA", AprovadorId = 1, NomeDoAprovador = "Mario" };
        ...
        public void Deve_validar_solicitacao_de_manutencao_a_ser_analisada()
        {
            ...
            AfirmaExtensao.VerificarMensagem(() => _analiseDeAprovacaoDaSolicitacao.Analisar(_dto), mensagemEsperada);
        }
